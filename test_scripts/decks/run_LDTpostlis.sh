...
do
    ...
    echo ncks -A -v TBOT,GREENNESS /short/w35/ccc561/WRF/run_nu-wrf_v8/test_scripts/LIS_offline/lis_input.d${dom}.nc tmp.nc
    ncks -A -v TBOT,GREENNESS -d month,2,2 /short/w35/ccc561/WRF/run_nu-wrf_v8/test_scripts/LIS_offline/lis_input.d${dom}.nc tmp.nc 
    if [ "$?" -ne "0" ]; then
