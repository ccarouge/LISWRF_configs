...
codepath=/short/w35/ccc561/WRF/nuwrf/installs//short/w35/ccc561/WRF/nuwrf/installs/newbuild
...
do
    ...
    echo ncks -A -v TBOT,GREENNESS /short/w35/ccc561/WRF/run_nu-wrf_v8/tests_lis_v9p2/LIS_offline/lis_input.d${dom}.nc tmp.nc
    ncks -A -v TBOT,GREENNESS -d month,2,2 /short/w35/ccc561/WRF/run_nu-wrf_v8/tests_lis_v9p2/LIS_offline/lis_input.d${dom}.nc tmp.nc 
    if [ "$?" -ne "0" ]; then
